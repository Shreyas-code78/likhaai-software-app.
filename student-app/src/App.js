    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/browse-writers" element={<PrivateRoute><BrowseWriters /></PrivateRoute>} />
          <Route path="/writer/:id" element={<PrivateRoute><WriterProfile /></PrivateRoute>} />
          ...
          <Route path="/payment/:taskId" element={<PrivateRoute><Payment /></PrivateRoute>} />
